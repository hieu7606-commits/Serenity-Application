...
public class MovieColumns
{
    ...
    // The value is a list of genre ids; GenreListFormatter (GenreListFormatter.tsx) shows their
    // names instead of "1,2". The attribute itself is generated by sergen from that .tsx file.
    // QuickFilter adds a genre multi-select above the grid. MovieGrid.getQuickFilters moves its
    // value into MovieListRequest.Genres, and MovieListHandler filters on that.
